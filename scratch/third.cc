...
std::string throughput_file = "mix/throughput.txt";

double alpha_resume_interval = 55, rp_timer, ewma_gain = 1 / 32;
...
uint32_t qlen_dump_interval = 100000000, qlen_mon_interval = 100000000;
uint64_t qlen_mon_start = 000000000, qlen_mon_end = 100000000;
...
int main(int argc, char *argv[])
{
	...
	FILE *tp_output = fopen(throughput_file.c_str(), "w");
	//
	// install RDMA driver
	//
	for (uint32_t i = 0; i < node_num; i++){
